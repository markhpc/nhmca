package DataCollector::CollectlIOWait;
use strict;
use warnings;
...
#
#  my $query = "SELECT node,timestamp,wait from collectliodata WHERE system='" . $cluster . "' AND timestamp >= '$start' AND timestamp < '$end'";
#  print "$query\n";
