package DataCollector::CollectlIOUtil;
use strict;
use warnings;
...
#
#  my $query = "SELECT node,timestamp,util from collectliodata WHERE system='" . $cluster . "' AND timestamp >= '$start' AND timestamp < '$end'";
#  print "$query\n";
